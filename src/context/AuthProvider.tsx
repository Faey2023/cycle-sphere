...
const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const [isUser, setIsUser] = useState<boolean>(false); // User role status
  ...
  const authInfo: AuthInfo = {
    ...
    loading,
    isAdmin,
    isUser, // Include isUser in the context value
    createUser,
    loginUser,
  };
